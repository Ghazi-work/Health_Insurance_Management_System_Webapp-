...
{
    public partial class AddingIdentityUsers_Policies_Departments_companies : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeptDescription = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadOfficeAddress = table.Column<string>(nullable: true),
                    HelplineNumber = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Insurance_Companies", x => x.CompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PolicyId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(nullable: false),
                    PolicyTitle = table.Column<string>(nullable: true),
                    PolicyDescription = table.Column<string>(nullable: true),
                    PolicyDuration = table.Column<int>(nullable: false),
                    PolicyPaymentType = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_Insurance_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermenantAddress = table.Column<string>(nullable: true),
                    ...
                    DetailOfHealthDisease = table.Column<string>(nullable: true),
                    Medications = table.Column<string>(nullable: true),
                    StrenghtOfMedication = table.Column<string>(nullable: true),
                    FrequencyTaken = table.Column<string>(nullable: true),
                    JoinDate = table.Column<DateTime>(nullable: false),
                    Salary = table.Column<int>(nullable: false),
                    DeptId = table.Column<int>(nullable: false),
                    PolicyId = table.Column<int>(nullable: false),
                    ClaimMoney = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Policies_PolicyId",
                        column: x => x.PolicyId,
